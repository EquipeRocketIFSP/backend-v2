...
public class TratamentoClinicoDocumento extends Documento {
    public TratamentoClinicoDocumento(){
        ...
        this.declaraCienciaRiscos = "Declaro, ainda, ter sido esclarecido(a) acerca dos possíveis riscos inerentes à situação clínica do animal, bem como do(s) tratamento(s) proposto(s), estando o(a) referido(a) profissional isento(a) de quaisquer responsabilidades decorrentes de tais riscos.";
